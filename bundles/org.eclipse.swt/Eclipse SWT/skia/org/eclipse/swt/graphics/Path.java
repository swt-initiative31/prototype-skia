...
public class Path extends Resource {
	 ...
	 *                                     <ul>
	 *                                     <li>ERROR_NULL_ARGUMENT - if the device
	 *                                     is null and there is no current
	 *                                     device</li>
	 *                                     </ul>
	 ...
	 * @exception SWTError
	 *                                     <ul>
	 *                                     <li>ERROR_NO_HANDLES if a handle for the
	 *                                     path could not be obtained</li>
	 *                                     </ul>
	 *
	 * @see #dispose()
	 */
	 ...
	 * <code>flatness</code> is less than or equal to zero, an unflatten copy of the
	 * path is created. Otherwise, it specifies the maximum error between the path
	 * and its flatten copy. Smaller numbers give better approximation.
	 * <p>
	 * This operation requires the operating system's advanced graphics subsystem
	 * which may not be available on some platforms.
	 * </p>
	 ...
	 *                                     is null and there is no current
	 *                                     device</li>
	 *                                     <li>ERROR_NULL_ARGUMENT - if the path is
	 *                                     null</li>
	 ...
	 *                                     is null and there is no current
	 *                                     device</li>
	 *                                     <li>ERROR_NULL_ARGUMENT - if the data is
	 *                                     null</li>
	 *                                     </ul>
	 * @exception SWTException
	 *                                     <ul>
	 ...
	 * <code>arcAngle</code> degrees. Angles are interpreted such that 0 degrees is
	 ...
	 * @exception IllegalArgumentException
	 *                                     <ul>
	 *                                     <li>ERROR_NULL_ARGUMENT - if the font is
	 *                                     null</li>
	...
	/**
	 * Closes the current sub path by adding to the receiver a line from the current
	 * point of the path back to the starting point of the sub path.
	 *
	 * @exception SWTException
	 *                         <ul>
	 *                         <li>ERROR_GRAPHIC_DISPOSED - if the receiver has been
	...
	/**
	 * Returns <code>true</code> if the specified point is contained by the receiver
	 * and false otherwise.
	 * <p>
	 ...
	 * @param outline controls whether to check the outline or contained area of the
	 *                path
	 ...
	 * the smallest rectangle that will completely contain the receiver (i.e. the
	 * bounding box).
	 *
	 ...
	 *                                     parameter is null</li>
	 *                                     <li>ERROR_INVALID_ARGUMENT - if the
	 *                                     parameter is too small to hold the
	 *                                     bounding box</li>
	 *                                     </ul>
	 * @exception SWTException
	 *                                     <ul>
	...
	/**
	 * Replaces the first two elements in the parameter with values that describe
	 ...
	 *                                     parameter is null</li>
	 *                                     <li>ERROR_INVALID_ARGUMENT - if the
	 *                                     parameter is too small to hold the end
	 *                                     point</li>
	 *                                     </ul>
	 * @exception SWTException
	 *                                     <ul>
	...
	/**
	 * Adds to the receiver a line from the current point to the point specified by
	 * (x, y).
	 *
	 ...
	 *
	 * @return <code>true</code> when the Path is disposed, and <code>false</code>
	 *         otherwise
	 */
	@Override
	...
	/**
	 * Sets the current point of the receiver to the point specified by (x, y). Note
	 * that this starts a new sub path.
	 *
