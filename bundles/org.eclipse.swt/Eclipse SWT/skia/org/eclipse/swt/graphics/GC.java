...
public final class GC extends Resource {
	 ...
	 *                                     <ul>
	 *                                     <li>ERROR_NULL_ARGUMENT - if the drawable
	 *                                     is null</li>
	 *                                     <li>ERROR_NULL_ARGUMENT - if there is no
	 *                                     current device</li>
	 *                                     <li>ERROR_INVALID_ARGUMENT - if the
	 *                                     drawable is an image that is not a bitmap
	 *                                     or an icon - if the drawable is an image
	 *                                     or printer that is already selected into
	 *                                     another graphics context</li>
	 *                                     </ul>
	 * @exception SWTError
	 *                                     <ul>
	 *                                     <li>ERROR_NO_HANDLES if a handle could
	 *                                     not be obtained for GC creation</li>
...
//		}
	 ...
	 *
	 *                                     // * @see #getAdvanced // * @see
	 *                                     #setAdvanced // * @see #setTextAntialias
	 *
	 * @since 3.1
	 */
...
//		}
	...
	public void setBackground(Color systemColor) {
		System.err.println("setBackground not yet implemented in GC...");
	}

	public void fillOval(int i, int j, int width, int height) {
		if (handle == null)
			System.err.println("GC: handle not set...");
		System.err.println("fillOval not yet implemented in GC...");
	}

	public void setForeground(Color red) {
		System.err.println("setForeground not yet implemented in GC...");
	}

	public void drawRectangle(int i, int j, int k, int l) {
		System.err.println("drawRectangle not yet implemented in GC...");
	}

	public void drawString(String string, int i, int j) {
		System.err.println("drawString not yet implemented in GC...");
	}
}
