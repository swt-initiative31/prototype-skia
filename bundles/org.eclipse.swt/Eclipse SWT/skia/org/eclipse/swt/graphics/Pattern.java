...
public class Pattern extends Resource {
	...
	/**
	 * Constructs a new Pattern given an image. Drawing with the resulting pattern
	 * will cause the image to be tiled over the resulting area.
	 * <p>
	 ...
	 *                                     is null and there is no current device,
	 *                                     or the image is null</li>
	 ...
	 *                                     pattern could not be obtained</li>
	 *                                     </ul>
	 *
	 * @see #dispose()
	 */
	 ...
	 * Drawing with the pattern will cause the resulting area to be tiled with the
	 * gradient specified by the arguments.
	 * <p>
	 * This operation requires the operating system's advanced graphics subsystem
	 * which may not be available on some platforms.
	 * </p>
	 ...
	 *                                     <li>ERROR_NULL_ARGUMENT - if the device
	 *                                     is null and there is no current device,
	 *                                     or if either color1 or color2 is
	 *                                     null</li>
	 *                                     <li>ERROR_INVALID_ARGUMENT - if either
	 *                                     color1 or color2 has been disposed</li>
	 *                                     </ul>
	 * @exception SWTException
	 *                                     <ul>
	 *                                     <li>ERROR_NO_GRAPHICS_LIBRARY - if
	 ...
	 * <p>
	 * This method gets the dispose state for the Pattern. When a Pattern has been
