...
public class Canvas extends Composite {
	 ...
	 * Returns the caret.
	 * <p>
	 * The caret for the control is automatically hidden and shown when the control
	 * is painted or resized, when focus is gained or lost and when an the control
	 * is scrolled. To avoid drawing on top of the caret, the programmer must hide
	...
	/**
	 * Scrolls a rectangular area of the receiver by first copying the source area
	 * to the destination and then causing the area of the source which is not
	 * covered by the destination to be repainted. Children that intersect the
	 * rectangle are optionally moved during the operation. In addition, all
	 ...
	 * @param all    <code>true</code>if children should be scrolled, and
	 ...
	 * @exception IllegalArgumentException
	 *                                     <ul>
	 *                                     <li>ERROR_INVALID_ARGUMENT - if the caret
	 *                                     has been disposed</li>
	 *                                     </ul>
	 * @exception SWTException
	 *                                     <ul>
	 ...
	 * @exception IllegalArgumentException
	 *                                     <ul>
	 *                                     <li>ERROR_INVALID_ARGUMENT - if the IME
	 *                                     has been disposed</li>
	 *                                     </ul>
	 * @exception SWTException
	 *                                     <ul>
